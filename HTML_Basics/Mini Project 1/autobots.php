...
echo "<td> <button><a href='index.php'>Home</a></button></td>";
echo"<br>";
...
echo "<img class = autobot src='Images/arcee.png' alt='Acree' />";
...
echo "<p class = header>Role: Leader of the Dinobots:</p>";
echo "<p class = content>Role: Autobot Warrior</p>";
